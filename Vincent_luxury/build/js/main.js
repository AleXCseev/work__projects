$(function () {
	...
	function cardModal() {
		$(".card__modal").click(function() {
			console.log($(this).data("video"))
			console.log($(this).data("modal"))

			var $card = String($(this).data("modal"))

			var selector = $card + " .modal__info-hidden"

			console.log($(selector).addClass("active"))
			// $(".info__modal-wrapper").append($(card + " .modal__info-hidden"))
		})
	}
